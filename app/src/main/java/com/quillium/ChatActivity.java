...
import com.quillium.Adapter.ChatAdapter;
...
public class ChatActivity extends BaseActivity {
    ...
    private void sendMessage(){
        ...
        if (!isReceiverAvailable){
            try {
                ...
                sendNofification(body.toString());
    ...
    private void sendNofification(String messageBody){
    ...
    private void updateConversion(String message){
        DocumentReference documentReference =
                firestore.collection(Constants.KEY_COLLECTION_CONVERSATIONS).document(conversionId);
